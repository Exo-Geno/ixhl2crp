...
ITEM.functions.EquipUn = {
    ...
    OnRun = function(item)
        ...
        item.player:EmitSound("conflictstudios/player/arm_oneshot_0"..math.random(1,7)..".ogg", 70, math.random(90,110))
...
ITEM.functions.Equip = {
    ...
    OnRun = function(item, creationClient)
        ...
        ply:EmitSound("conflictstudios/player/arm_oneshot_0"..math.random(1,7)..".ogg", 70, math.random(90,110))
