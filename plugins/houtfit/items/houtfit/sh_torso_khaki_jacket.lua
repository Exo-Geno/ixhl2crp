ITEM.name = "Khaki Jacket"
ITEM.description = "A khaki jacket. Keeps you warm, and has many pockets."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat8.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(-39.23, -7.19, 195.95),
    ang = Angle(76.53, 10.32, 0),
    fov = 4.05
}
