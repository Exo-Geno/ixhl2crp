ITEM.name = "Supporter White Suit Jacket"
ITEM.description = "A white, casual suit jacket for collaborators."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat7_white.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(-39.23, -7.19, 195.95),
    ang = Angle(76.4, 10.08, 0),
    fov = 4.05
}
