ITEM.name = "Blue Suit Trousers"
ITEM.description = "A pair of blue suit trousers. They look very high quality."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/legs_ca_3.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
