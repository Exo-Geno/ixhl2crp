ITEM.name = "Black Stylish Jacket"
ITEM.description = "A black, well sewn jacket. Keeps you warm and stylish."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat5.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(-39.23, -7.19, 195.95),
    ang = Angle(76.43, 10.08, 0),
    fov = 4.05
}
