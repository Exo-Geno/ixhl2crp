ITEM.name = "White Trench Coat"
ITEM.description = "A very high quality, white trench coat. Used by the elite."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_ca_9.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(16.44, 3.23, 199.26),
    ang = Angle(92.85, 10.65, 0),
    fov = 4.01
}
