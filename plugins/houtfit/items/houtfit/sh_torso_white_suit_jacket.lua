ITEM.name = "White Suit Jacket"
ITEM.description = "A very high quality white suit. You look serene in it."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_ca_4.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
