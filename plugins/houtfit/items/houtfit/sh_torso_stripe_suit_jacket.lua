ITEM.name = "Striped Suit Jacket"
ITEM.description = "A very high quality black suit with white lining. You look suave in it."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_ca_6.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
