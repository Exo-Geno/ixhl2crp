ITEM.name = "Face Mask"
ITEM.description = "A Surgical mask that can be used some times before needed to be thrown away. Keeps germs and bacteria away from the mouth."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/update_items/medicmask_item.mdl"
ITEM.width = 1
ITEM.height = 1
ITEM.iconCam = {
