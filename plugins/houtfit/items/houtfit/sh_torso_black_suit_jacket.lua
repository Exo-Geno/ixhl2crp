ITEM.name = "Supporter Black Suit Jacket"
ITEM.description = "A black, casual suit jacket for collaborators."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat7_black.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(25.67, 4.1, 198.3),
    ang = Angle(95.02, 9, 0),
    fov = 4.32
}
