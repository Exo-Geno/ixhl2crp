ITEM.name = "Blue Suit Jacket"
ITEM.description = "A very high quality blue suit. Used by elite collaborators."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_ca_7.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
