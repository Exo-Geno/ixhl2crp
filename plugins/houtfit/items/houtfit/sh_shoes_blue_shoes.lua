ITEM.name = "Blue Shoes"
ITEM.description = "A pair of blue shoes. For casual wear."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/shoes_blue.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
      pos = Vector(-0.76, -0.13, 200),
      ang = Angle(90.28, 189.76, 0),
      fov = 4.17
}
