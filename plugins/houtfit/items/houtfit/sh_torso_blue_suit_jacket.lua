ITEM.name = "Supporter Blue Suit Jacket"
ITEM.description = "A blue, casual suit jacket for collaborators."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat7_blue.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
