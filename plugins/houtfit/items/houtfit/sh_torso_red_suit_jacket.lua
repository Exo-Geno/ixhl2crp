ITEM.name = "Red Suit Jacket"
ITEM.description = "A very high quality red suit. You look passionate in it."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_ca_3.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
