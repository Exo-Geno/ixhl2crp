ITEM.name = "Brown Suit Jacket"
ITEM.description = "A brown, casual suit jacket."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat7.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(-39.23, -7.19, 195.95),
    ang = Angle(76.32, 10.07, 0),
    fov = 4.05
}
