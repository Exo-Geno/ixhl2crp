ITEM.name = "Dark Grey Pants"
ITEM.description = "A pair of dark grey pants. Made to last."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/legs_citizen5.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(-0.76, -0.13, 200),
    ang = Angle(90.56, 189.79, 0),
    fov = 6.03
}
