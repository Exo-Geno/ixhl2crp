ITEM.name = "Sporty Jacket"
ITEM.description = "A sporty jacket. Can keep you warm and looking fly."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_alyxcoat9.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
