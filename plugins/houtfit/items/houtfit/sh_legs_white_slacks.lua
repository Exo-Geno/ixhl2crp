ITEM.name = "White Suit Trousers"
ITEM.description = "A pair of white suit trousers. They look very high quality."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/legs_ca_2.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
