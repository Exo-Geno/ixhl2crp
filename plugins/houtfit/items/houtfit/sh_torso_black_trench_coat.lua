ITEM.name = "Black Trench Coat"
ITEM.description = "A very high quality, black trench coat. Used by the elite."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_ca_8.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
