...
ITEM.description = "A white button down top with a red cross band sewn on."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_citizen_medic.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(-39.23, -7.19, 195.95),
    ang = Angle(76.94, 10.16, 0),
    fov = 4.05
}
