ITEM.name = "Worn Shirt"
ITEM.description = "A black button down top. It's rather rough and worn."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_citizen_refugee.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(-39.23, -7.19, 195.95),
    ang = Angle(76.92, 10.12, 0),
    fov = 4.05
}
