ITEM.name = "Yellow Worker's Jacket"
ITEM.description = "A sturdy, heavy knit jacket with yellow design."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/torso_worker1.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
