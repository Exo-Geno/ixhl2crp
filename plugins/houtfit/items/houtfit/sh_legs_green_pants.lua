ITEM.name = "Green Pants"
ITEM.description = "A pair of green pants. Made to last."
ITEM.category = "Clothing"
ITEM.model = "models/willardnetworks/clothingitems/legs_citizen2.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
    pos = Vector(-0.76, -0.13, 200),
    ang = Angle(90.61, 189.77, 0),
    fov = 6.03
}
